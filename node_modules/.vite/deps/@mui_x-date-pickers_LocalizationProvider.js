...
var MuiPickersAdapterContext = React39.createContext(null);
if (true) {
...
var LocalizationProvider = function LocalizationProvider2(inProps) {
  ...
  } = (_React$useContext = React39.useContext(MuiPickersAdapterContext)) != null ? _React$useContext : {
    utils: void 0,
    localeText: void 0
  };
  ...
  const localeText = React39.useMemo(() => _extends({}, themeLocaleText, parentLocaleText, inLocaleText), [themeLocaleText, parentLocaleText, inLocaleText]);
  const utils = React39.useMemo(() => {
    if (!DateAdapter) {
      if (parentUtils) {
        return parentUtils;
      }
...
`));
  ...
  const defaultDates = React39.useMemo(() => {
    if (!utils) {
      return null;
    }
    return {
...
true ? LocalizationProvider.propTypes = {
  ...
  dateFormats: import_prop_types22.default.shape({
    ...
    fullDateTime: import_prop_types22.default.string,
    fullDateTime12h: import_prop_types22.default.string,
    fullDateTime24h: import_prop_types22.default.string,
    fullDateWithWeekday: import_prop_types22.default.string,
    ...
    monthAndDate: import_prop_types22.default.string,
    monthAndYear: import_prop_types22.default.string,
